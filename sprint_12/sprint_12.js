...
function t09() {
  ...
  const text_node_09 = document.createTextNode(
...
function t10() {
  ...
  td10_2.textContent =
    "Гхола — клон, искусственное существо, которое выращивается в аксолотль-чане";
...
function t17() {
  if (document.querySelector(".out-17")) {
    document.querySelector(".out-17").outerHTML =
      '<mark class="m-17">Thufir Hawat</mark>';
  }
}
...
function t18() {
  if (document.querySelector(".out-18")) {
    document.querySelector(".out-18").outerText =
      '<mark class="m-18">Thufir Hawat</mark>';
  }
}
...
function t19() {
  ...
  document
    .querySelector(".out-19")
    .insertAdjacentHTML("afterend", "<mark>TEST</mark>");
